...
2.42 Verify the text “Welcome to our store”
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicsPage.sendText(electronicsPage.firstName, "Manish");
        electronicsPage.sendText(electronicsPage.lastName, "Tyagi");
        ...
        electronicsPage.sendText(electronicsPage.password, "Manish123");
        electronicsPage.sendText(electronicsPage.confirmPassword, "Manish123");
        ...
        electronicsPage.sendText(electronicsPage.cardHolderName, "Manish Tyagi");
